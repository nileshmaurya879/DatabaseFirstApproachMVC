...
namespace DatabaseFirstAproachMVC.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public CategoryController(DatabaseFirstApproachContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categories != null ? 
                          ...
                          Problem("Entity set 'DatabaseFirstApproachContext.Categories'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DatabaseFirstApproachContext.Categories'  is null.");
            }
            var category = await _context.Categories.FindAsync(id);
            if (category != null)
            {
